            ...
            loginSnapchatApi({ code: code, state: state })
                .then(function (response) {
                    ...
                    if (response.data) {
                        ...
                        console.log('login Snapchat fail');
                    }
                })
