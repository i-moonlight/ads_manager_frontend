...
const UploaderModal = (props) => {
    ...
    const sizeFileList_image_Facebook_special = [
        { width: 2062, height: 1080 } //1.91:1
    ];
    ...
    const sizeFileList_image_LinkedIn_special = [
        { width: 2062, height: 1080 } //1.91:1
    ];
    ...
    const sizeFileList_image_Meta_special = [
        { width: 2062, height: 1080 } //1.91:1
    ];
    ...
    return (
        <div className="uploader_modal_container">
            ...
            <div className="uploader_modal_size_media_valid">
                Google:
                {sizeFileList_image_Google.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                    );
                })}
            </div>
            <div className="uploader_modal_size_media_valid">
                Facebook:
                {sizeFileList_image_Facebook_special.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_image_Facebook.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_video_Facebook.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                    );
                })}
            ...
            <div className="uploader_modal_size_media_valid">
                Instagram:
                {sizeFileList_image_Instagram.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_video_Instagram.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                Meta:
                {sizeFileList_image_Meta.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_image_Meta_special.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_video_Meta.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                Messenger:
                {sizeFileList_image_Messenger.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_video_Messenger.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                LinkedIn:
                {sizeFileList_image_LinkedIn_special.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_image_LinkedIn.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                Pinterest:
                {sizeFileList_image_Pinterest.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
                ...
                {sizeFileList_video_Pinterest.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                Snapchat:
                {sizeFileList_video_Snapchat.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="warning" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
            ...
            <div className="uploader_modal_size_media_valid">
                Youtube:
                {sizeFileList_video_Youtube.map((item, index) => {
                    return (
                        <Badge key={index} pill variant="danger" className="mr-1">
                            {item.width}x{item.height}px{item.wRatio ? '(' + item.wRatio + ':' + item.hRatio + ')' : ''}
                        </Badge>
